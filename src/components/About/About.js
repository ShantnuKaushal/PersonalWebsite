...
export default function About() {
  const details = [
    ...
    "I love working with databases, machine learning models, and web development frameworks. Whether it's building predictive models, designing databases or creating functional websites, I enjoy leveraging my skills to contribute to impactful projects and develop innovative solutions.",
